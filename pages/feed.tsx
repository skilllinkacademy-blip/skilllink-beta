...
function CatIcon({ k }: { k: CategoryKey }) {
  const common = { className: "catSvg" };
  if (k === "חשמל")
    return (
...
function avatarFallback(name: string) {
  return `https://ui-avatars.com/api/?name=${encodeURIComponent(name)}&background=1877F2&color=fff&bold=true&size=256`;
}
  ...
  return (
    <main dir="rtl" className="sl">
        ...
        <section className="main">
          <section className="hero">
            ...
            <div className="heroIn">
              <h1 className="heroT">ברוכים הבאים{viewer?.full_name ? `, ${safeName(viewer.full_name)}` : ""}!</h1>
              <p className="heroS">מצא מנטורים ואנשי מקצוע לפי תחום. המספרים מתעדכנים אוטומטית מהמערכת.</p>
            </div>
          </section>
              ...
              return (
                <div key={c.key} className="cat">
                  <div className="catTop">
                    <div className="catIcon"><CatIcon k={c.key} /></div>
      ...
      <style jsx>{`
        ...
        .sIc{width:18px;height:18px;color:#6b7280}
        .sIn{
          width:100%;
        ...
        .search:has(.sIn:focus){
          box-shadow: 0 0 0 4px rgba(24,119,242,.18), 0 10px 26px rgba(17,24,39,.06);
        ...
        .uName{font-weight:800;color:#111827}
        .ava{
        ...
        .bell{width:20px;height:20px;color:#111827}
        ...
        .heroBg{
          ...
          background:
            radial-gradient(circle at 20% 30%, rgba(24,119,242,.18) 0, transparent 40%),
            radial-gradient(circle at 70% 40%, rgba(17,24,39,.06) 0, transparent 45%),
            linear-gradient(180deg, rgba(255,255,255,1), rgba(255,255,255,1));
          opacity:.9;
        }
        .heroIn{position:relative;padding:26px 18px;text-align:center}
        .heroT{margin:0;font-size:38px;font-weight:950;letter-spacing:-.7px}
        .heroS{margin:10px auto 0;max-width:740px;color:rgba(17,24,39,.70);font-weight:650}
        ...
        .catSvg{width:28px;height:28px;color:#111827}
        .catMeta{font-size:12px;font-weight:850;color:rgba(17,24,39,.60)}
        .catT{margin-top:10px;font-weight:950}
        .catS{margin-top:4px;font-size:12px;font-weight:650;color:rgba(17,24,39,.65)}

        .secHead{
          margin-top:18px;
          display:flex;align-items:flex-end;justify-content:space-between;
        }
        .secT{margin:0;font-size:18px;font-weight:950}
        .emptyTag{
          font-size:12px;
          font-weight:900;
          color:#1877f2;
        ...
        .mImg{aspect-ratio: 4/3; background:#e5e7eb}
        .mImg img{width:100%;height:100%;object-fit:cover;display:block}
        .mBody{padding:12px;text-align:center}
        .mName{font-weight:950}
        .mTitle{margin-top:2px;font-size:12px;font-weight:700;color:rgba(17,24,39,.66)}
        .pill{
          margin-top:10px;
          border-radius:999px;
          padding:9px 14px;
          ...
          border:0;
          font-weight:950;
          box-shadow: 0 10px 24px rgba(24,119,242,.26);
        }
        ...
        .sideHint{margin-top:8px;color:rgba(17,24,39,.65);font-weight:700}
        ...
        .skLine.w70{width:70%}
        .skLine.w50{width:50%}
        .skBtn{height:34px;border-radius:999px;background:#dbeafe;margin-top:12px}
